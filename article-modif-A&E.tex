...
\begin{tabular}{lr}
\hline
Estimate & Value \\ \hline
$\hatkvar$ & 1.371 \\ 
$\kest_p,~p=1$ & 1.557 \\ 
$\hatkmean$ & 1.587 \\ 
$\hatkmpe$ & 1.628 \\ 
$\kest_p,~p=0.95$ & 1.672 \\ 
$\kest_{\mathrm{maxratio}},~\hat{p}_{\mathrm{maxratio}}=0.654$ & 1.637 \\ \hline
\end{tabular}
\end{table*}
...
\begin{figure*}[!h]
\centering
\includegraphics[width=12cm]{Figures/forecast_error.pdf}
...
Figure~\ref{fig:forecast_squared_error_distrib} shows the distribution of the mean squared error. 
\begin{figure*}[!h]
\centering
\includegraphics[width=10cm]{Figures/forecast_error_distrib_2.pdf}
...
The Continuous ranked probability score (CRPS) measure the squared difference between the predicted CDF $F_{\mathrm{pred}}$ using a calibrated value, and the CDF of the observation $F_{\mathrm{pred}}^o$. 
\begin{equation}
\label{eq:def_crps}
